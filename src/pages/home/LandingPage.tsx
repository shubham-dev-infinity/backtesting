    ...
    return (
        <>
                    ...
                    <div className='container'>
                        <div className='content_mt'>
                            <div className='lg:flex lg:justify-between lg:items-center'>
                                <div className='lg:flex-2 mb-8 lg:mb-0'>
                                ...
                                <div className='lg:flex-1'>
                                    {!isLoggedIn && (
                                        <div className="card_box bg-white rounded-lg shadow-md p-6 lg:p-10">
                                            <h3 className="card_title text-2xl text-center font-semibold mb-8">Login</h3>
                                            <div className="login_signup flex">
                                                <Button className="primaryBtn flex-1" >Login</Button>
                                                <Button className="signup_btn flex-1"><Link to='/signup'>Sign Up</Link></Button>
                                            </div>
                                            <div className="input_text mt-5">
                                                <div className="e_mail">
                                                    <h5 className="text-gray-500 text-base">Email</h5>
                                                    <input className='inputClass w-full px-4 py-2 border-b border-gray-300' type="email" placeholder="Enter your Email here" name="userId" value={formFields.userId} onChange={handleFormChange} />
                                                </div>
                                                <div className="e_mail">
                                                    <h5 className="text-gray-500 text-base">Password</h5>
                                                    <input className='inputClass w-full px-4 py-2 border-b border-gray-300' type="password" placeholder="Enter your Email here" name="password" value={formFields.password} onChange={handleFormChange} />
                                                </div>
                                                <p className="forgot_text text-right"><Link to='/reset-password'>Forgot Password?</Link> </p>
                                            </div>
                                            <div className="main_btn mt-10">
                                                <Button className="btn_wrap bg-blue-500 text-white w-full rounded-l">Login</Button>
                                                <p className="btn_wrap_text text-gray-500 text-base my-2">Or</p>
                                                <p className="btn_wrap_text text-gray-500 text-base mb-10">Don’t have an account? <span className="signup_mark text-blue-500"><Link to={'/signup'}>Sign Up</Link></span></p>
                                            </div>
                                        </div>
                                    )}
                                </div>
                    ...
                    <div className="text-center relative">
                        <p className="text-base md:text-lg lg:text-xl mt-10">
                            <h5 className="text-base md:text-lg lg:text-xl mb-4">
                                Backtesting lets you look at your strategies on historical data to decide how well it would have worked within the past.
                                In case you've got created a technique with which you're prepared to go live, the Backtesting highlight will assist you to get it in the event that your strategies are reasonable and possibly effective.
                            </h5>
                            <h5 className="text-base md:text-lg lg:text-xl mb-4">
                                Backtesting lets you look at your strategies on historical data to decide how well it would have worked within the past.
                                In case you've got created a technique with which you're prepared to go live, the Backtesting highlight will assist you to get it in the event that your strategies are reasonable and possibly effective.
            ...
            <section className="bg-white py-6 md:py-10 lg:py-14">
                <div className="container mx-auto">
                    <div className="relative">
                        <div className="text-2xl font-semibold relative mb-4">
                            <h2 className="text-2xl md:text-3xl lg:text-4xl font-semibold text-center">Features</h2>
                        ...
                        <div className="md:flex lg:flex grid gap-x-8 mt-10">
                            <div className="md:w-1/2 lg:w-1/2 flex items-center">
                                <img src="/assets/img/feature1.png" alt="star" className="w-full feature_Img" />
                            </div>
                            <div className="md:w-1/2 lg:w-1/2 flex items-center mt-6 md:mt-0 lg:mt-0 px-8">
                                <h5 className="text-base md:text-lg lg:text-xl mb-4">
                                    The app offers a vast collection of safety talks tailored specifically for the construction and marine industries. Workers can easily search and browse through the library to find relevant topics and materials for their safety briefings. This app provides a comprehensive solution for promoting safety awareness and compliance.
                                </h5>
                            </div>
                        </div>
                        <div className="md:flex md:flex-row lg:flex mt-6 md:mt-0 lg:mt-0 flex flex-col-reverse">
                            ...
                            <div className="md:w-1/2 lg:w-1/2 flex items-center">
                                <img src="/assets/img/feature2.png" alt="star" className="w-full feature_Img" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="bg-white py-6 md:py-10 lg:py-14">
                <div className="container mx-auto">
                    <div className="text-2xl font-semibold relative mb-4">
                        <h2 className="text-2xl md:text-3xl lg:text-4xl font-semibold text-center">Subscription Plans</h2>
                        <div className="absolute h-3 w-4/12 bg-blue-500 rounded-full mb-16 mt-2 left-1/2 transform -translate-x-1/2 shadow-md backdrop-blur-md"></div>
                    </div>
            ...
            <section className="bg-white py-6 md:py-10 lg:py-14">
                <div className="container mx-auto">
                    <div className="relative">
                        <div className="text-2xl font-semibold relative mb-4">
                            <h2 className="text-2xl md:text-3xl lg:text-4xl font-semibold text-center">Get To Know us</h2>
                            <div className="absolute h-3 w-4/12 bg-blue-500 rounded-full mb-16 mt-2 left-1/2 transform -translate-x-1/2 shadow-md backdrop-blur-md"></div>
                        </div>
                        ...
                        <h5 className="text-base md:text-lg lg:text-xl flex justify-center mb-2">Exalgo Infotech Pvt. Ltd.</h5>
                        <h5 className="text-base md:text-lg lg:text-xl flex justify-center">Address: Surat, Gujarat, India</h5>
                    </div>
                </div>
            </section>
        </>
